        ...
        if line.startswith("#include"):
         ...
         try:
           ...
           # open com.bat on line.replace("#include ", "")+".py" in subprocess
            ...
            line = line.replace("#include ", "").strip()  # Remove "#include" and any leading/trailing whitespace
            filename = r"site_packages\\" + line + ".py"
            with open(r"site_packages\\" + line.replace("#include ", "").strip() + ".py", "r") as f:
                print(f.read())
            ...
            os.remove(line.replace("#include ", "")+".py")          

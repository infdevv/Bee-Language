...
def compiler(string):
    ...
    invalid_terms=["main_init_transfer_javascript","main_init_super_variable_function", "main_init_super_variable_function_read", "main_init_cleanup_super_variable", "main_init_write_file", "main_init_read_file", "main_init_javascript_runner"]
    ...
    string = string.replace("include", "import")
    ...
    for line in new_string:
        if line == new_string[-1]:
            if line.endswith("main_init_cleanup_super_variable()"):
                exit = 1
                break
            else:
